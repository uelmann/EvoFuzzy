...
- GPU leftover (operator override 2026-08-16): the detached 12-wide wave wrote 58/74 jobs then judged incomplete because workers billed `12 × orchestrator wall` (`$17.41 + 12×4.25h×$1.10 + $8 reserve ≥ $80`) while real spend was **$62.40 / $80**. Leftover finish used **completed worker hours + this-wave n_jobs × elapsed**. App `ap-SqE5e4FC9Bj2cDRuoNV0Vw` completed the 6 leftover jobs (seed-43 fold 15 + null fold-21 shuffles 106–110). Full 3-seed + 20/20 null. Cap still $80. LIVE/PARKED criterion text unchanged.
